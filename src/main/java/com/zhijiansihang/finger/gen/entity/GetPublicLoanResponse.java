...
public class GetPublicLoanResponse extends MobileMessage {


	/**
	 * @see com.zhijiansihang.finger.gen.entity.GetPublicLoanResponse#getLoanList
	 * 
	 */
	@JsonInclude(Include.NON_NULL)
	...
	public GetPublicLoanResponse(String statusCode, String statusMessage) {
