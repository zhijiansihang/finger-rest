...
public class MyCollectionLoanResponse extends MobileMessage {


	/**
	 * @see com.zhijiansihang.finger.gen.entity.MyCollectionLoanResponse#getLoanList
	 * 
	 */
	@JsonInclude(Include.NON_NULL)
	...
	public MyCollectionLoanResponse() {
		super();
	...
	public MyCollectionLoanResponse(String statusCode, String statusMessage) {
