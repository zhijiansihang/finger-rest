...
public class GetPrivateLoanResponse extends MobileMessage {


	/**
	 * @see com.zhijiansihang.finger.gen.entity.GetPrivateLoanResponse#getLoanList
	 * 
	 */
	@JsonInclude(Include.NON_NULL)
	...
	public GetPrivateLoanResponse(String statusCode, String statusMessage) {
