...
public interface UserDemandSolutionDAO {
    ...
    @Select({
            "select uds.demand_id ,ud.serial_number as serial_number_demand ,us.adopt_count,ufc.friend_counts,uds.id,u.institution_name,uds.is_operate_solution,u.logo,u.real_name,u.nick_name,",
            "us.serial_number,uds.solution_id,uds.solution_user_id,ufd.service_direction",
