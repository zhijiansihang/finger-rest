...
import com.shawn.finger.dao.mysql.model.UserSolutionDO;
import com.shawn.finger.dao.mysql.model.UserSolutionDOExample;
...
public interface UserSolutionDAO {
    ...
    @ResultMap("com.shawn.finger.dao.mysql.mapper.UserSolutionDAO.BaseResultMap")
